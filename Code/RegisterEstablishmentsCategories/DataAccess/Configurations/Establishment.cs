...
namespace DataAccess.Configurations
{
    public class Establishment : EntityTypeConfiguration<Models.Establishment>
    {
        public Establishment()
        {
            ...
            Property(x => x.Email).HasColumnName("ds_email").HasMaxLength(30).IsOptional();
            Property(x => x.Address).HasColumnName("ds_address").HasMaxLength(50).IsOptional();
            ...
            Property(x => x.PhoneNumber).HasColumnName("ds_phoneNumber").HasMaxLength(14).IsOptional();
            Property(x => x.RegisterDate).HasColumnName("dt_registerDate").IsOptional();
            Property(x => x.CategoryID).HasColumnName("num_category").IsOptional();
            Property(x => x.StatusID).HasColumnName("num_status").IsOptional();
            Property(x => x.Agency).HasColumnName("ds_agency").HasMaxLength(5).IsOptional();
            Property(x => x.Account).HasColumnName("ds_account").HasMaxLength(8).IsOptional();
